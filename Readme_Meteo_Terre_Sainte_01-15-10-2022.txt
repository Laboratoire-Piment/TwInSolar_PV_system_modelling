% Metadata for files "Meteo_Terre_Sainte_01-15-10-2022.txt"
% Created by Mathieu DAVID, March 1, 2024
% TwInSolar WP2
...
DHI : modeled from GHI (decomposition with Erbs' model)
BNI : modeled BNI = (GHI-DHI)/cos(zenith angle)
